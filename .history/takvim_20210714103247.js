...
function fillCalendar() {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        document.getElementById(`pazar${i}`).style = "color: #0000FF; font-weight:500;";
        document.getElementById(`pazartesi${i}`).style = "color: #0000FF;  font-weight:500;";
        document.getElementById(`sali${i}`).style = "color: #0000FF;  font-weight:500;";
        document.getElementById(`carsamba${i}`).style = "color: #0000FF;  font-weight:500;";
        document.getElementById(`persembe${i}`).style = "color: #0000FF;  font-weight:500;";
        document.getElementById(`cuma${i}`).style = "color: #0000FF;  font-weight:500;";
        document.getElementById(`cumartesi${i}`).style = "color: #0000FF;  font-weight:bo500ld;";
