...
function fillCalendar() {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        document.getElementById(`pazar${i}`).style.fontWeight = "600";

        document.getElementById(`pazartesi${i}`).style.color = "#0000FF";
        document.getElementById(`pazartesi${i}`).style.fontWeight = "600";

        document.getElementById(`sali${i}`).style.color = "#0000FF";
        document.getElementById(`sali${i}`).style.fontWeight = "600";

        document.getElementById(`carsamba${i}`).style.color = "#0000FF";
        document.getElementById(`carsamba${i}`).style.fontWeight = "600";

        document.getElementById(`persembe${i}`).style.color = "#0000FF";
        document.getElementById(`persembe${i}`).style.fontWeight = "600";

        document.getElementById(`cuma${i}`).style.color = "#0000FF";
        document.getElementById(`cuma${i}`).style.fontWeight = "600";

        document.getElementById(`cumartesi${i}`).style.color = "#0000FF";
        document.getElementById(`cumartesi${i}`).style.fontWeight = "600";
