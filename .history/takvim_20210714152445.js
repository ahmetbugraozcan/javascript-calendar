...
function addTodoToDatabase(key, value){
    db.transaction(function (tx) { 
        tx.executeSql('CREATE TABLE IF NOT EXISTS YAPILACAKLAR (id unique, class)'); 
        tx.executeSql('INSERT INTO CLASS (key, value) VALUES (?, ?)', [key, value]);; 
...
function opendb() {
    ...
    db.transaction(function (tx) {   
        tx.executeSql('CREATE TABLE IF NOT EXISTS YAPILACAKLAR (id unique, log)'); 
     });
}
