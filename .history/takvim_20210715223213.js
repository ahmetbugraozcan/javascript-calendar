...
opendb();
readData(startCalendar)
console.log("test");




function startCalendar(databaseData){
    console.log("data : " + databaseDatas);
    fillCalendar(databaseDatas);
 }



  function readData(myCallback){
...
function fillCalendar(databaseData) {
   console.log(databaseData.rows[0]["id"]);
            if(databaseData.rows[0]["id"] == "2021-6-sali2"){
                console.log("True")
            }
