...
function fillCalendarFunction(){
    ...
    for (let i = 0; i < 6; i++) {
      //hepsini tek styleda toplayabiliriz
      var color = get_average_rgb(document.getElementById("calendar-header").style.backgroundImage);
    ...
    document.getElementById(`pazartesi${i}`).style.fontWeight = "500";
      ...
      document.getElementById(`sali${i}`).style.color = color;
      ...
      document.getElementById(`pazartesi${i}`).style.backgroundColor = "#F8E7EA";
      document.getElementById(`sali${i}`).style.backgroundColor = "#F8E7EA";
      document.getElementById(`carsamba${i}`).style.backgroundColor = "#F8E7EA";
      document.getElementById(`persembe${i}`).style.backgroundColor = "#F8E7EA";
      document.getElementById(`cuma${i}`).style.backgroundColor = "#F8E7EA";
      document.getElementById(`cumartesi${i}`).style.backgroundColor = "#F8E7EA";
      document.getElementById(`pazar${i}`).style.backgroundColor = "#F8E7EA";
