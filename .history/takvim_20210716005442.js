...
function fillCalendarFunction(){
    ...
    for(var i = 0; i < databaseResponse["rows"].length; i++){
        ...
        for(var i = 0; i < 6; i++){
            var pazartesiKey = `pazartesi${i}` + "-" + currentYear + "-" + currentMonth ;
            var saliKey= `sali${i}` + "-" + currentYear + "-" + currentMonth ;
            var carsambaKey = `carsamba${i}` + "-" + currentYear + "-" + currentMonth ;
            var persembeKey = `persembe${i}` + "-" + currentYear + "-" + currentMonth ;
            var cumaKey = `cuma${i}` + "-" + currentYear + "-" + currentMonth ;
            var cumartesiKey = `cumartesi${i}` + "-" + currentYear + "-" + currentMonth ;
            var pazarKey =  `pazar${i}` + "-" + currentYear + "-" + currentMonth ;
        }
