...
function readChildNode(docID) {
    ...
    if(doc.hasChildNodes && (document.getElementById(docID).childNodes[1] != undefined)){
        ...
        return document.getElementById(docID).childNodes[0].textContent + " "+ getMonthAsString(currentMonth) + currentYear + " " + document.getElementById(docID).childNodes[1].textContent;
    }else{
        return "";
    }
 }
