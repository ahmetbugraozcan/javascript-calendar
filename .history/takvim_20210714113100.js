...
function setBackgroundImage(){
    ...
    switch(currentMonth){
        case 11,0,1:
            doc.body.style.backgroundImage= "url('/images/kis.png');";
            break;
        case 2,3,4:
            doc.body.style.backgroundImage= "url('/images/ilkbahar.jpg');";
            break;
        case 5,6,7:
         doc.body.style.backgroundImage= "url('/images/yaz.jpg');";
            break;
        case 8,9,10:
            
            doc.body.style.backgroundImage= "url('/images/sonbahar.jpg');";
            break;
    }
}
