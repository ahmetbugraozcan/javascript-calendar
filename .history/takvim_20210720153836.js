...
var today = new Date();
var defaultCellStyle = "font-weight:500;color:#0000FF;background-color:#F8E7EA;";
...
function fillCalendarFunction(){
    ...
    for (let i = 0; i < 6; i++) {
      //--------------------------------------------------------------------  
document.getElementById(`pazartesi${i}`).style = "font-weight:500;color:#0000FF;background-color:#F8E7EA;"
