...
function fillCalendar() {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        document.getElementById(`pazar${i}`).style.color = "#f26430";
        document.getElementById(`pazartesi${i}`).style.color = "#f26430";
        document.getElementById(`sali${i}`).style.color = "#f26430";
        document.getElementById(`carsamba${i}`).style.color = "#f26430";
        document.getElementById(`persembe${i}`).style.color = "#f26430";
        document.getElementById(`cuma${i}`).style.color = "#f26430";
        document.getElementById(`cumartesi${i}`).style.color = "#f26430";
