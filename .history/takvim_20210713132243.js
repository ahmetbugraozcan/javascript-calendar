...
function fillCalendar() {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        document.getElementById(`pazar${i}`).style.backgroundColor = "#cd533b";
        document.getElementById(`pazartesi${i}`).style.backgroundColor = "#cd533b";
        document.getElementById(`sali${i}`).style.backgroundColor = "#cd533b";
        document.getElementById(`carsamba${i}`).style.backgroundColor = "#cd533b";
        document.getElementById(`persembe${i}`).style.backgroundColor = "#cd533b";
        document.getElementById(`cuma${i}`).style.backgroundColor = "#cd533b";
        document.getElementById(`cumartesi${i}`).style.backgroundColor = "#cd533b";
