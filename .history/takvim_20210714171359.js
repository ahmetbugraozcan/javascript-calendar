...
function fillCalendar() {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        document.getElementById(`pazartesi${i}`).firstChild.textContent = getDayAsString(pazartesi[i]);
...
document.getElementById("pazartesi0").lastChild.textContent.color = "red"
document.getElementById("pazartesi0").lastChild.textContent= "dklmsdfksfdslaşlsfmaslfsa"
