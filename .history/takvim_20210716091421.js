...
function fillCalendarFunction(){
    ...
    for(var i = 0; i < databaseResponse["rows"].length; i++){
        ...
        if( pazartesiKey.includes(databaseResponse["rows"][i]["id"])){
...
function removeChildNode(docName){
    var list = document.getElementById(docName);   // Get the <ul> element with id="myList"
    console.log(list.parentNode.removeChild(list))  
