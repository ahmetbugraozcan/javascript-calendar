...
document.getElementById(`pazar${i}`).style = defaultCellStyle;
    ...
    //--------------------------------------------------------------------  
        if(!isFromThisMonth(pazar[i].date)){
            document.getElementById(`pazar${i}`).style.opacity = "0.5"
        }
        if(!isFromThisMonth(pazartesi[i].date)){
            document.getElementById(`pazartesi${i}`).style.opacity = "0.5"
        }
        if(!isFromThisMonth(sali[i].date)){
            document.getElementById(`sali${i}`).style.opacity = "0.5"
        }
        if(!isFromThisMonth(carsamba[i].date)){
            document.getElementById(`carsamba${i}`).style.opacity = "0.5"
        }
        if(!isFromThisMonth(persembe[i].date)){
            document.getElementById(`persembe${i}`).style.opacity = "0.5"
        }
        if(!isFromThisMonth(cuma[i].date)){
            document.getElementById(`cuma${i}`).style.opacity = "0.5"
        }
        if(!isFromThisMonth(cumartesi[i].date)){
            document.getElementById(`cumartesi${i}`).style.opacity = "0.5"
        }
