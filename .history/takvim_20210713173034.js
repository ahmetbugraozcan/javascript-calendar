...
function testfunc(text){
    console.log("textimiz : " + text);
    console.log(    document.getElementById("not-defteri").firstChild);
    document.getElementById("not-defteri").firstChild.innerHTML = `${text}`;
    document.getElementById("not-defteri").style.display = "block";
