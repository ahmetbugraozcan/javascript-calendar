...
function testfunc(text){
    ...
    //databaseye birşeyler eklerken key olarak bu text değeri örneğin pazartesi[4] value olarak da valuesunu yollarız ve çekerken de BU KEY DEĞERİNE GÖRE ÇEKERİZ
