...
function fillCalendar() {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        document.getElementById(`pazar${i}`).style.color = "#F8E7EA";
        document.getElementById(`pazartesi${i}`).style.color = "#F8E7EA";
        document.getElementById(`sali${i}`).style.color = "#F8E7EA";
        document.getElementById(`carsamba${i}`).style.color = "#F8E7EA";
        document.getElementById(`persembe${i}`).style.color = "r#F8E7EA";
        document.getElementById(`cuma${i}`).style.color = "#F8E7EA";
        document.getElementById(`cumartesi${i}`).style.color = "#F8E7EA";
