...
function fillCalendarFunction(){
    ...
    for (let i = 0; i < 6; i++) {
        ...
        console.log(document.getElementById("sali0"))

    setBackgroundImage();
    var e = GetElementInsideContainer("sali0", "sali0text");
}
...
function removeAllChildNodes(docID) {
    parent = document.getElementById(docID);
