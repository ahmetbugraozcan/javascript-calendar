...
function fillCalendar() {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        document.getElementById(`pazar${i}`).style.color = "color: #0000FF; ";
        document.getElementById(`pazar${i}`).style.fontWeight = "font-weight:500;";

        document.getElementById(`pazartesi${i}`).style.color = "color: #0000FF;  ";
        document.getElementById(`pazartesi${i}`).style.fontWeight = "font-weight:500;;  ";

        document.getElementById(`sali${i}`).style.color = "color: #0000FF;  ";
        document.getElementById(`sali${i}`).style.fontWeight = "font-weight:500;;  ";

        document.getElementById(`carsamba${i}`).style.color = "color: #0000FF;  ";
        document.getElementById(`carsamba${i}`).style.fontWeight = "font-weight:500;;  ";

        document.getElementById(`persembe${i}`).style.color = "color: #0000FF;  ";
        document.getElementById(`persembe${i}`).style.fontWeight = "font-weight:500;;  ";

        document.getElementById(`cuma${i}`).style.color = "color: #0000FF;  ";
        document.getElementById(`cuma${i}`).style.fontWeight = "font-weight:500;;  ";

        document.getElementById(`cumartesi${i}`).style.color = "color: #0000FF;  ";
        document.getElementById(`cumartesi${i}`).style.fontWeight = "font-weight:500;;  ";
