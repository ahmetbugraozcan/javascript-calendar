...
var ilkbaharBackground = "url('/images/ilkbahar.jpg');";
var yazBackground = "url('/images/yaz.jpg');";
var sonbaharBackground= "url('/images/sonbahar.jpg');";
var kisBackground = "url('/images/kis.jpg');";
...
fillCalendar();
document.getElementById("calendar-header").style.backgroundImage = setBackgroundImage();
...
function setBackgroundImage(){
    switch(currentMonth){
        case 11,0,1:
            return kisBackground;
        case 2,3,4:
            return ilkbaharBackground;
        case 5,6,7:
            return yazBackground;
        case 8,9,10:
            return sonbaharBackground;
    }
}
