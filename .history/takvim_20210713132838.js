...
function fillCalendar() {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        document.getElementById(`pazar${i}`).style.backgroundColor = "#264653";
        document.getElementById(`pazartesi${i}`).style.backgroundColor = "#264653";
        document.getElementById(`sali${i}`).style.backgroundColor = "#264653";
        document.getElementById(`carsamba${i}`).style.backgroundColor = "#264653";
        document.getElementById(`persembe${i}`).style.backgroundColor = "#264653";
        document.getElementById(`cuma${i}`).style.backgroundColor = "#264653";
        document.getElementById(`cumartesi${i}`).style.backgroundColor = "#264653";
