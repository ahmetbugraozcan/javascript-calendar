...
function fillCalendar() {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        document.getElementById(`pazar${i}`).style.backgroundColor = "#D91E36";
        document.getElementById(`pazartesi${i}`).style.backgroundColor = "#D91E36";
        document.getElementById(`sali${i}`).style.backgroundColor = "#D91E36";
        document.getElementById(`carsamba${i}`).style.backgroundColor = "#D91E36";
        document.getElementById(`persembe${i}`).style.backgroundColor = "#D91E36";
        document.getElementById(`cuma${i}`).style.backgroundColor = "#D91E36";
        document.getElementById(`cumartesi${i}`).style.backgroundColor = "#D91E36";
