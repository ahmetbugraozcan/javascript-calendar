import * as promise from './sinif.js';
//basılan hücrenin konumu hesaplanır. ardından arkasındaki elemanlardan itibaren bir for döngüsü açılır
//
console.log(promise)
// var x = pazar;
// console.log(`${x[0]}`)
...
function fillCalendarFunction(){
    ...
    for (let i = 1; i <= 42; i++) {
        ...
        switch (baslanacakDate.getDay()) {
            case 0:
                // var date = new Sinif(baslanacakDate,baslanacakDate.toLocaleDateString())
                // var date = {
