...
function fillCalendar() {
    ...
    document.getElementById("currentDate").innerHTML = currentYear + " " + currentMonth;
    for (let i = 0; i < 6; i++) {
        document.getElementById(`pazar${i}`).innerHTML = pazar[i];
        document.getElementById(`pazartesi${i}`).innerHTML = pazartesi[i];
        document.getElementById(`sali${i}`).innerHTML = sali[i];
        document.getElementById(`carsamba${i}`).innerHTML = carsamba[i];
        document.getElementById(`persembe${i}`).innerHTML = persembe[i];
        document.getElementById(`cuma${i}`).innerHTML = cuma[i];
        document.getElementById(`cumartesi${i}`).innerHTML = cumartesi[i];

        document.getElementById(`pazar${i}`).style.backgroundColor = "red";
        document.getElementById(`pazartesi${i}`).style.backgroundColor = "red";
        document.getElementById(`sali${i}`).style.backgroundColor = "red";
        document.getElementById(`carsamba${i}`).style.backgroundColor = "red";
        document.getElementById(`persembe${i}`).style.backgroundColor = "red";
        document.getElementById(`cuma${i}`).style.backgroundColor = "red";
        document.getElementById(`cumartesi${i}`).style.backgroundColor = "red";
