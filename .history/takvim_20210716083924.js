...
function fillCalendarFunction(){
    ...
    for(var i = 0; i < databaseResponse["rows"].length; i++){
        ...
        carsambaKey.push(`sali${j}` + "-" + currentYear + "-" + currentMonth )
        persembeKey.push(`sali${j}` + "-" + currentYear + "-" + currentMonth )
        cumaKey.push(`sali${j}` + "-" + currentYear + "-" + currentMonth )
        cumartesiKey.push(`sali${j}` + "-" + currentYear + "-" + currentMonth )
        pazarKey.push(`sali${j}` + "-" + currentYear + "-" + currentMonth )
